      ...
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="31 Sunset Boulevard" name="address" required="">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Los Angeles" name="city" required="">
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="some@gmail.com" name="email" required="">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
